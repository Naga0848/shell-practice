...
#Interview Question: Can you store a the output of a command in to a specific variable.
#Answer: We can explain the below mentioned two exapmples for this question.
