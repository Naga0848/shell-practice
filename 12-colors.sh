...
then
    ...
    echo -e "Mysql is already installed...$R nothing to do $N"
fi
...
then
    ...
    echo -e "nginx is already installed...$R nothing to do $N"
fi
...
then
    ...
    echo -e "python3 is already installed...$R nothing to do $N"
fi
# dnf install mysql -y
